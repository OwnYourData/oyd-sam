...
class PluginGatlingTest extends Simulation {
    ...
    val headers_http = Map(
        ...
        val authorization_header = "Basic " + Base64.getEncoder.encodeToString("samapp:mySecretOAuthSecret".getBytes(StandardCharsets.UTF_8))
    ...
    val scn = scenario("Test the Plugin entity")
        ...
        .repeat(2) {
            ...
            .post("/api/plugins")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "identifier":"SAMPLE_TEXT", "version":"SAMPLE_TEXT", "versionNumber":"0", "description":"SAMPLE_TEXT", "zip":null, "downloads":"0", "ratings":null}""")).asJSON
            .check(status.is(201))

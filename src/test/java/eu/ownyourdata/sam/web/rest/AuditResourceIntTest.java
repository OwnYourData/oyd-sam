...
import eu.ownyourdata.sam.config.audit.AuditEventConverter;
import eu.ownyourdata.sam.domain.PersistentAuditEvent;
import eu.ownyourdata.sam.repository.PersistenceAuditEventRepository;
import eu.ownyourdata.sam.service.AuditEventService;
